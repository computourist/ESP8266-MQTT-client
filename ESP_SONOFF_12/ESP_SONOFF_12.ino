...
#define wifi_ssid_A "xxxx-1"					// wifi station name
#define wifi_password_A "xxxxxxxxxx"			// wifi password
#define wifi_ssid_B "xxxx-2"					// fallback wifi station name; if not present use same as A
#define wifi_password_B "xxxxxxxxxx"			// fallback wifi password; if not present use same as A
#define mqtt_server "192.168.xxx.xxx"			// mqtt server IP
#define nodeId 20								// node ID
